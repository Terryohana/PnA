...
return [
    ...
    'timestamp' => 1675659509,
    'checksum' => '8755229c01afe4e9aff2811cad867e06',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.social-seo-metatags.seo.breadcrumb' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.social-seo-metatags.seo.breadcrumb',
                'validation' => 'strict'
            ],
            ...
            'plugins.social-seo-metatags.image' => [
                'type' => '_parent',
                'name' => 'plugins.social-seo-metatags.image',
                'form_field' => false
            ],
            'plugins.social-seo-metatags.image.use_cache' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.social-seo-metatags.image.use_cache',
                'validation' => 'strict'
            ],
            ...
            'plugins.adsense.global' => [
                'type' => 'section',
                'underline' => 1,
                'name' => 'plugins.adsense.global',
                'validation' => 'strict'
            ],
            ...
            'plugins.adsense.options' => [
                'type' => 'fieldset',
                'collapsible' => false,
                'icon' => 'gear',
                'name' => 'plugins.adsense.options',
                'validation' => 'strict'
            ],
            ...
            'plugins.adsense.horizontal' => [
                'type' => 'fieldset',
                'collapsible' => true,
                'icon' => 'mars-stroke-h',
                'name' => 'plugins.adsense.horizontal',
                'validation' => 'strict'
            ],
            ...
            'plugins.adsense.vertical' => [
                'type' => 'fieldset',
                'collapsible' => true,
                'icon' => 'mars-stroke-v',
                'name' => 'plugins.adsense.vertical',
                'validation' => 'strict'
            ],
            ...
            'plugins.adsense.square' => [
                'type' => 'fieldset',
                'collapsible' => true,
                'icon' => 'square-o',
                'name' => 'plugins.adsense.square',
                'validation' => 'strict'
            ],
            'plugins.adsense.modular_ads' => [
                'type' => 'fieldset',
                'collapsed' => false,
                'collapsible' => true,
                'icon' => 'th-large',
                'name' => 'plugins.adsense.modular_ads',
                'validation' => 'strict'
            ],
            ...
            'plugins.adsense.page_ads' => [
                'type' => 'fieldset',
                'collapsed' => true,
                'icon' => 'list',
                'name' => 'plugins.adsense.page_ads',
                'validation' => 'strict'
            ],
            'plugins.adsense.default' => [
                'type' => 'section',
                'underline' => 1,
                'name' => 'plugins.adsense.default',
                'validation' => 'strict'
            ],
            'plugins.random' => [
                'type' => '_root',
            ...
            'plugins' => [
                'social-seo-metatags' => [
                    ...
                    'seo' => [
                        ...
                        'breadcrumb' => 'plugins.social-seo-metatags.seo.breadcrumb'
                    ],
                    'quote' => [
                        'convert_simple' => 'plugins.social-seo-metatags.quote.convert_simple'
                    ],
                    'image' => [
                        'use_cache' => 'plugins.social-seo-metatags.image.use_cache'
                    ],
                    'default' => [
                ...
                'adsense' => [
                    ...
                    'default' => 'plugins.adsense.default',
                    'options' => 'plugins.adsense.options',
                    'adsense' => [
                        'options' => [
                    ...
                    'modular_ads' => 'plugins.adsense.modular_ads',
                    'horizontal' => 'plugins.adsense.horizontal',
                    'vertical' => 'plugins.adsense.vertical',
                    'square' => 'plugins.adsense.square',
                    'page_ads' => 'plugins.adsense.page_ads'
                ],
                'random' => [
