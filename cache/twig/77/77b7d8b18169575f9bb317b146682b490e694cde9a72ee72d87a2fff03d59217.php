...
class __TwigTemplate_cdebdc7c3ef7d2d7d587c98b3784b24750bb66305c9b108dd6f935201d72aa90 extends \Twig\Template
{
    ...
    <tr>
        ...
        <th>";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.BACKUP_DATE"), "html", null, true);
        echo "</th>
        <th>";
        // line 7
        ...
        <th class=\"right pad\">";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.SIZE"), "html", null, true);
        echo "</th>
        <th class=\"right pad\">";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.ACTION"), "html", null, true);
        echo "</th>
    </tr>
    </thead>
    <tbody>
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["backup"]) {
            // line 14
            echo "        ";
            $context["encoded_name"] = twig_urlencode_filter($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->base64EncodeFilter($this->getAttribute($context["backup"], "filename", [])));
            // line 15
            echo "        ";
            ...
            <td class=\"right pad\">";
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->niceFilesizeFunc($this->getAttribute($context["backup"], "size", [])), "html", null, true);
            echo "</td>
    ...
    ";
        ...
        if (!$context['_iterated']) {
            ...
            // line 28
            echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_ADMIN.BACKUPS_NOT_GENERATED"), "html", null, true);
            echo "</td>
        </tr>
    ";
        }
...
", "forms/fields/backupshistory/backupshistory.html.twig", "/home/terry/Downloads/grav-skeleton-blog-site+admin-2.0 (1).0/user/plugins/admin/themes/grav/templates/forms/fields/backupshistory/backupshistory.html.twig");
    }
}
